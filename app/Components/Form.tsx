...
export default function Form() {
  ...
  const [showPicker, setShowPicker] = useState(false); // Add this line
        ...
        <div className="flex-1 ml-4">
          ...
          >
            <div className="flex justify-end">
              ...
              />
              <Button
                className="rounded-full w-8 h-8 dark:bg-gray-900 dark:text-gray-100 hover:invert transition absolute"
                onClick={() => setShowPicker(!showPicker)}
                type="button"
              >
                <EmojiIcon className="w-6 h-6 absolute top-1 left-1" fill="#ffffff"/>
